...
// Single source of truth for supported languages — re-exported from the central
// registry (src/types/krishi.ts) rather than redefined here. Only these 7 are
// ever supported: English, Telugu, Hindi, Tamil, Kannada, Malayalam, Marathi.
import type { Language } from '../../types/krishi';
