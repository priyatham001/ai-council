...
import { UserRole, Language, NotificationItem, FarmerPersona } from '../types';
...
export const AppNavbar: React.FC<AppNavbarProps> = ({ onOpenCalculator }) => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('smartagrilink_lang_changed', update);
    ...
    return () => {
      ...
      window.removeEventListener('smartagrilink_lang_changed', update);
  ...
  const farmerLinks = [
    ...
    { label: t('lots', lang), path: '/marketplace/lots' },
    { label: t('buyers', lang), path: '/marketplace/buyers' },
    { label: t('offers', lang), path: '/marketplace/offers' },
    { label: t('logistics', lang), path: '/marketplace/logistics' },
    { label: t('storage', lang), path: '/marketplace/storage' },
    { label: t('transactions', lang), path: '/marketplace/transactions' },
    { label: t('grievances', lang), path: '/marketplace/grievances' },
    { label: t('markets', lang), path: '/marketplace/markets' },
    { label: t('aiAdvisor', lang), path: '/marketplace/advisor' }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5">
            ...
            {/* Language Selector (11 Pan-India Languages) */}
            <div className="relative">
              <select
                value={lang}
                onChange={(e) => handleLangSwitch(e.target.value as Language)}
                className="appearance-none bg-gray-50 border border-gray-200 hover:border-gray-300 text-gray-700 text-xs font-semibold rounded-lg pl-6 pr-7 py-1.5 focus:outline-none focus:ring-1 focus:ring-brand-500 cursor-pointer"
              ...
              <Globe className="w-3.5 h-3.5 text-gray-500 absolute left-2 top-2 pointer-events-none" />
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="capitalize">{t(`role${role.charAt(0).toUpperCase() + role.slice(1)}`, lang)}</span>
