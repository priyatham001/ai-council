    ...
    <div className="space-y-6 animate-fadeIn pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {filteredLots.map((lot) => (
          <div
            key={lot.id}
            className="bg-white dark:bg-stone-900 rounded-2xl border border-gray-200 dark:border-stone-800 p-5 shadow-2xs hover:shadow-2xl transition-all duration-300 flex flex-col justify-between space-y-4 card-3d preserve-3d transform-gpu hover:scale-[1.02] hover:-translate-y-1"
          >
