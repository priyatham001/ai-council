      ...
      <div className="p-6 sm:p-8">
        ...
        {mode === 'scanning' && (
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="relative w-full max-w-lg mx-auto h-[320px] rounded-3xl overflow-hidden border-2 border-emerald-500 shadow-2xl bg-stone-950 flex items-center justify-center perspective-1000 preserve-3d">
              {capturedImages[0] && (
                <img
                  src={capturedImages[0]}
              ...
              {/* 3D High-Tech Animated Scanning Laser Beam & Orbital Rings */}
              <div className="absolute inset-0 pointer-events-none">
                <div className="w-full h-2 bg-gradient-to-r from-transparent via-emerald-400 to-transparent shadow-[0_0_25px_#34d399] animate-laserSweep absolute z-20" />
                <div className="absolute inset-8 rounded-full border border-dashed border-emerald-400/30 animate-orbital" />
        ...
        {mode === 'result' && (
          <div className="space-y-8 animate-in fade-in zoom-in-95 duration-400">
            ...
            <div
              className={`rounded-3xl p-6 sm:p-8 border-2 shadow-2xl text-center space-y-4 card-3d preserve-3d animate-badgeReveal ${
                aiGrade === 'A'
