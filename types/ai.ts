...
export interface ChatMessage {
  ...
  progress?: {
    stage: string;
    stepIndex: number;
    providerStatuses: Record<string, 'pending' | 'thinking' | 'completed' | 'error'>;
    stageStatuses: {
      analyzer: 'pending' | 'thinking' | 'completed';
      critic: 'pending' | 'thinking' | 'completed';
      judge: 'pending' | 'thinking' | 'completed';
    };
  };
  error?: string;
}
